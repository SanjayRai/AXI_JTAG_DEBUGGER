...
(* dont_touch = "true" *)reg i_data_mover_aresetn_reg;

(* dont_touch = "true" *)reg [31:0]GPIO_OUT_A_i;
(* dont_touch = "true" *)reg [31:0]GPIO_OUT_B_i;
...
assign data_mover_aresetn = i_data_mover_aresetn_reg;
...
assign GP_OUT_32_A = GPIO_OUT_A_i;
assign GP_OUT_32_B = GPIO_OUT_B_i;

always @ (posedge clk)
begin
    GPIO_IN_A <= GP_IN_32_A;
    GPIO_IN_B <= GP_IN_32_B;
    GPIO_OUT_A_i <= GPIO_OUT_A;
    GPIO_OUT_B_i <= GPIO_OUT_B;
   i_data_mover_aresetn_reg <= i_data_mover_aresetn;
end
