...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_INCLUDE_SG {0}  ] $axi_cdma_0
  ...
  connect_bd_net -net jtag_axi_debugger_ip_0_GP_OUT_32_A [get_bd_pins jtag_axi_debugger_ip_0/GP_IN_32_A] [get_bd_pins jtag_axi_debugger_ip_0/GP_OUT_32_A]
  connect_bd_net -net jtag_axi_debugger_ip_0_GP_OUT_32_B [get_bd_pins jtag_axi_debugger_ip_0/GP_IN_32_B] [get_bd_pins jtag_axi_debugger_ip_0/GP_OUT_32_B]
  ...
  connect_bd_net -net rst_mig_7series_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins jtag_axi_debugger_ip_0_axi_periph/ARESETN] [get_bd_pins jtag_axi_debugger_ip_0_axi_periph/M00_ARESETN] [get_bd_pins jtag_axi_debugger_ip_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_100M/peripheral_aresetn]
